...
library(argparse)
sample.id <- "p019n_p028n_p030n_p033n"
# __________VDJ DATA ANYLYSIS PIPELINE__________
PROJECT <- "Lung_dataset1"
...
path.to.main.input <- "/media/hieunguyen/HNHD01/data/UKK/Lung/capsule-8321305/data/tmp"
...
path2input <- file.path(path.to.main.input)
